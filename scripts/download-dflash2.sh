...
# node1 then pulls it over the QSFP rsync daemon:  rsync -a rsync://<HEAD_IP>:8873/dflash2/ ~/models/GLM-5.3-Flash-DFlash2/
...
"$HF" download incoai/GLM-5.3-Flash-DFlash2 --local-dir ~/models/GLM-5.3-Flash-DFlash2 --max-workers 4 2>&1 | tee -a ~/glm53-cluster/logs/download-dflash2.log
