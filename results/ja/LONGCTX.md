...
## 並列（構成別、bench/throughput_probe.py: 強制長 256 / greedy、C=1 は 3 回中央値）
...
# RedHat 版再測（2026-09-02、構成 S: 262K / seqs 2 / DFlash2 k=7 / fp8 KV / KV profiler）

`bench/longctx.py`。手順・指標は `results/LONGCTX.md`（LibertAI 版 2026-09-01）と同一。decode は投機の受理率依存なので長文の主指標は TTFT / prefill。
...
| prompt tok | TTFT s (median) | prefill tok/s (median) | decode tok/s (median) | aggregate tok/s | wall s |
| ---------: | --------------: | ---------------------: | --------------------: | --------------: | -----: |
|      2,048 |             3.0 |                    676 |                  33.4 |            50.9 |     20 |
|      8,192 |             9.0 |                    963 |                  25.7 |            32.5 |     31 |
|     32,768 |            34.5 |                  1,054 |                  19.5 |            15.7 |     65 |
|    131,072 |           137.7 |                  1,069 |                  28.6 |             5.3 |    193 |
|    200,000 |           209.7 |                  1,070 |                  23.7 |             3.5 |    292 |
