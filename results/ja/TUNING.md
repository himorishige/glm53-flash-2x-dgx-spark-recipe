...
| s8 | `MAX_NUM_SEQS=8` | 934 | PASS | 27.24 | 0.361 | 76.38 (8) | — | 117 | 117 | 262K with 8 slots (MiaAI) — if it boots, Phase 2 parity without dropping context |
...
| P-65k-s8-dflash7 | `MAX_MODEL_LEN=65536 MAX_NUM_SEQS=8 KV_CACHE_MEMORY_BYTES=4445787956 SPEC_METHOD=dflash SPEC_MODEL=/models/GLM-5.3-Flash-DFlash2 MTP_NUM_TOKENS=7` | 892 | PASS | 31.32 | 0.335 | 62.67 (8) | 29.48 (5/5) | 112 | 111 | Phase 2 config P: parity with glm-5-3-flash-gguf (65536 / 8) + DFlash2 k=7 |

## 読み方と採用（2026-09-01 10:10、Phase 1 単因子スイープ完了時点）
...
| 未測（任意枠） | graphs（+1〜3% 報告）/ batched 8192・2048 / noautotune / b12x / util 0.90 | 凍結リスクか期待値が小さいため Phase 3 の後に回す |

**採用**

- **構成 S（速度・長文）**: `dflash7` = 262K / seqs 2 / DFlash2 k=7 / KV pin 3 GiB / marlin / eager / fp8_e4m3。Phase 3 の長文 × 並列に使う
...
## 品質ゲート追加（2026-09-01 11:20、Phase 2 の結果から）
